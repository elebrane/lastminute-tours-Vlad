...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Главное отличие — простота и скорость. Обычные агрегаторы требуют заполнить 10–15 фильтров. У нас — всего 2 поля. Кроме того, мы добавляем AI-описание от GigaChat Pro для каждого тура: что увидите, стоит ли брать прямо сейчас.",
  },
  {
    category: "Поиск туров",
    question: "Как работает поиск туров?",
    answer: "После ввода города и бюджета наш алгоритм запрашивает базу туров Level.Travel, фильтрует предложения с вылетом в ближайшие 7 дней, сортирует по цене и возвращает 3 самых выгодных варианта. Для каждого тура GigaChat Pro генерирует описание.",
  },
  {
    category: "Поиск туров",
  ...
  },
  {
    ...
    answer: "Описания генерирует нейросеть GigaChat Pro от Сбера. Она анализирует параметры тура (направление, отель, количество ночей, тип питания) и создаёт персонализированное описание: что успеете увидеть и стоит ли брать.",
  },
  {
    category: "ИИ и описания",
      ...
      <main className="flex-1 pt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  icon: Brain,
                  title: "О нейросети",
                  desc: "Как GigaChat Pro помогает выбрать тур и что означают его рекомендации",
        ...
        <section className="py-20 bg-slate-50" id="about-ai">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-3xl font-display font-bold mb-4 text-center">О нейросети GigaChat Pro</h2>
              ...
              {[
                {
                  ...
                  desc: "GigaChat Pro анализирует параметры тура (направление, отель, питание, количество ночей) и генерирует краткое, но информативное описание на русском языке.",
                },
                {
                  icon: Star,
